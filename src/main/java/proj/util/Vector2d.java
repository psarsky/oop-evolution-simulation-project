...
public record Vector2d(int x, int y) {
     ...
     *
     * @param other The other {@link Vector2d} to compare with.
     * @return      {@code true} if this vector precedes the other vector, {@code false} otherwise.
     */
     ...
     *
     * @param other The other {@link Vector2d} to compare with.
     * @return      {@code true} if this vector follows the other vector, {@code false} otherwise.
     */
     ...
     *
     * @param other The {@link Vector2d} to add.
     * @return      A new {@link Vector2d} representing the sum of the two vectors.
     */
     ...
     *
     * @param other The {@link Vector2d} to subtract.
     * @return      A new {@link Vector2d} representing the difference between the two vectors.
     */
     ...
     * @return      A new {@link Vector2d} representing the upper-right corner.
     */
     ...
     *
     * @param other The other {@link Vector2d}.
     * @return      A new {@link Vector2d} representing the lower-left corner.
     */
     ...
     *
     * @return A new {@link Vector2d} representing the opposite of this vector.
     */
     ...
     *
     * @return A {@link String} representing this vector
     */
    @Override
